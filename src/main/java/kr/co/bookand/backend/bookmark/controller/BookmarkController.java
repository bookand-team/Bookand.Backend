...
public class BookmarkController {
    ...
    public ResponseEntity<Message> deleteBookmark(@PathVariable Long bookmarkFolderId, @RequestBody BookmarkContentListRequest bookmarkRequest) {
        return ResponseEntity.ok(bookmarkService.deleteBookmarkContent(bookmarkFolderId, bookmarkRequest));
    }
