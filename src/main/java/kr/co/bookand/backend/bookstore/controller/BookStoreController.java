...
public class BookStoreController {
    ...
    @PostMapping("")
    public ResponseEntity<BookStoreResponse> createBookStore(
            @RequestBody BookStoreRequest bookStoreDto
    ) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<BookStoreResponse> findBookStore(
    ...
    @GetMapping("")
    public ResponseEntity<BookStorePageResponseApp> getBookStoreListApp(
    ...
    @GetMapping("/web")
    public ResponseEntity<BookStorePageResponse> getBookStoreList(
            @PageableDefault(sort = "modifiedAt", direction = Sort.Direction.DESC) Pageable pageable
    ) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<BookStoreWebResponse> updateBookStore(
            @PathVariable Long id,
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Message> deleteBookStore(
            @PathVariable Long id
    ) {
    ...
    @DeleteMapping("/list")
    public ResponseEntity<Message> deleteBookStoreList(
            @RequestBody BookStoreListRequest list
    ) {
    ...
    public ResponseEntity<BookStoreWebResponse> updateBookStoreStatus(
            @PathVariable Long id
    ) {
    ...
    @PostMapping("/report")
    public ResponseEntity<Message> reportBookStore(
