...
public enum ErrorCode {
    ...
    NOT_FOUND_BOOKSTORE("BOOKSTORE-ERR-100", "NOT FOUND BOOKSTORE", "서점을 찾을 수 업습니다.", 404),
    ...
    NOT_FOUND_BOOKMARK_CONTENT("BOOKMARK_CONTENT-ERR-100", "NOT FOUND BOOKMARK_CONTENT", "북마크 내욜을 찾을 수 없습니다.", 404),
