...
enum class ErrorCode(
    ...
    NOT_FOUND_SOCIAL_TYPE("MEMBER-ERR-207", "NOT_FOUND_SOCIAL_TYPE", "소셜 타입을 찾을 수 없습니다.", 400),
    ...
    ALREADY_DELETE_BOOKSTORE("BOOKSTORE-ERR-105", "ALREADY DELETE BOOKSTORE", "이미 삭제된 서점입니다.", 400),
    NOT_FOUND_REPORT_BOOKSTORE("BOOKSTORE-ERR-106", "NOT FOUND REPORT BOOKSTORE", "서점 제보를 찾을 수 없습니다.", 404),
    ...
    NOT_FOUND_BOOKMARK_BOOKSTORE("BOOKMARK-ERR-106", "NOT FOUND BOOKMARK BOOKSTORE", "북마크에서 서점을 찾을 수 없습니다.", 404),
    NOT_FOUND_BOOKMARK_ARTICLE("BOOKMARK-ERR-107", "NOT FOUND BOOKMARK ARTICLE", "북마크에서 아티클을 찾을 수 없습니다.", 404),
    NOT_FOUND_INIT_BOOKMARK_BOOKSTORE("BOOKMARK-ERR-108", "NOT FOUND INIT BOOKMARK BOOKSTORE", "서점 모아보기 폴더가 아닙니다.", 404),
    NOT_FOUND_INIT_BOOKMARK_ARTICLE("BOOKMARK-ERR-109", "NOT FOUND INIT BOOKMARK ARTICLE", "아티클 모아보기 폴더가 아닙니다.", 404),
    ...
    // Issue
    NOT_FOUND_ISSUE("ISSUE-ERR-100", "NOT FOUND ISSUE", "이슈를 찾을 수 없습니다.", 404),
