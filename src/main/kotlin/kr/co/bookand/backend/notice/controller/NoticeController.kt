...
class NoticeController(
    ...
    @ApiOperation(value = "공지사항 생성 (관리자)")
    @PostMapping
    fun createNotice(
    ...
    @ApiOperation(value = "공지사항 목록 조회 (관리자)")
    @GetMapping("/web")
    fun getNoticeList(
        @PageableDefault pageable: Pageable
    ): ResponseEntity<NoticePageResponse> {
    ...
    @ApiOperation(value = "공지사항 수정 (관리자)")
    ...
    @ApiOperation(value = "공지사항 삭제 (관리자)")
    ...
    @ApiOperation(value = "공지사항 상태 변경 (관리자)")
