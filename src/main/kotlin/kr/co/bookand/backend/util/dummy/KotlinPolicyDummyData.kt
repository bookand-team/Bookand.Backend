...
@Component
class KotlinPolicyDummyData(
    private val policyRepository: KotlinPolicyRepository
) {
    ...
    fun dummyDate() {
        if (policyRepository.count() > 0) {
            log.info("[0] 약관이 이미 존재하여 더미를 생성하지 않았습니다.")
            return
        }
    ...
    private val termsContent =
        "_< BOOK& >('https://www.bookand.co.kr'이하 'BOOK&')_은(는) 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.\n" +
                "\n" +
